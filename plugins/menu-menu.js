 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Pauli ?_
 ...
 *┃➤* _${usedPrefix}minarPaulicoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}darPaulicoins *cantidad*_
 ...
 *┃➤* _${usedPrefix}delPaulicoins *@tag*_
 ...
 *┃➤* _${usedPrefix}añadirPaulicoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🌸 𝗣𝗮𝘂𝗹𝗶 𝗕𝗼𝘁 𝗠𝗗 🌸', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
